...
const Register = () => {
    ...
    return (
        ...
        <>
            <div className="max-w-lg mx-auto mt-[11rem]  bg-white dark:bg-gray-800 rounded-lg shadow-md px-8 py-10 flex flex-col items-center">
                ...
                <form onSubmit={handleSubmit(onSubmit)} action="#" className='w-full' >
                   ...
                   <div className="flex items-start flex-col justify-start">
                    ...
                    <div className="flex items-start flex-col justify-start">
                        ...
                        <input type="password" id="confirmPassword"  {...register("ConfirmationPassword")} name="confirmPassword" className="w-full px-3 dark:text-gray-200 dark:bg-gray-900 py-2 rounded-md border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-500" />
                        <span className='text-red-300'>
